...
- (void)viewDidLoad {
    ...
    self.segmentBar.pageWidth = self.view.width / 2;
    ...
    self.pageScrollView.frame = CGRectMake(0, 0, self.view.width / 2, 200);
    self.pageScrollView.center = CGPointMake(self.view.width / 2, 200);
    
    self.pageScrollView.contentSize = CGSizeMake(self.view.width * 3, 0);
    self.pageScrollView.contentOffset = CGPointMake(self.view.width * 1, 0);
}
-(void)segmentedControl:(TLSegmentedControl *)segmentedControl didSelectIndex:(NSUInteger)index {
    self.pageScrollView.contentOffset = CGPointMake(index * (self.view.width / 2), 0);
}
